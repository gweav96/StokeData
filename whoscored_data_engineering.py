...
def find_offensive_actions(events_df):
    ...
    offensive_action_df = events_df[(events_df['type'].isin(offensive_actions)) & (events_df['satisfiedEventsTypes'].apply(lambda x: not (31 in x or 34 in x or 212 in x)))]
...
def find_defensive_actions(events_df):
    ...
    defensive_action_df = events_df[events_df['type'].isin(defensive_actions)]
